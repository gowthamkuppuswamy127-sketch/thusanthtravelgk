...
- **Look:** deep teal and sand gold with glass (frosted) panels. The signature element is the **kilometre stone**, the Indian highway milestone, used to show real distances from the Banashankari office.
